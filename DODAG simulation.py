...
if __name__ == '__main__':
    ...
    for obj in Node.all_instances:
        ...
        f.writelines("Node " + node + " sent " + sent + " packets and received " + received + " packets and generated " + generated + " packets."+"\n")
    print(f"{dodag.total_messages_received} out of 1000 messages reached the root node")
